...
namespace SteelRain.EditorTools
{
    public static class VerticalSliceBuilder
    {
        ...
        public static void BuildLevel01Graybox()
        {
            ...
            CreateSegmentTrigger("VillagePressureTrigger", 58f, "VillageWave.asset", player.transform);
            CreateSegmentTrigger("TrenchWaveTrigger", 72f, "TrenchWave.asset", player.transform);
            CreateSegmentTrigger("TrenchPressureTrigger", 94f, "TrenchWave.asset", player.transform);
            ...
            CreateUpgradePickup("Upgrade_CheckpointA_Recovery", new Vector2(34f, 1.2f));
            ...
            CreateUpgradePickup("Upgrade_VillagePressure_Reward", new Vector2(62f, 1.2f));
            ...
            CreateUpgradePickup("Upgrade_Trench_Recovery", new Vector2(88f, 1.2f));
            CreateUpgradePickup("Upgrade_CheckpointC_Recovery", new Vector2(104.8f, 1.2f));
            ...
            CreateUpgradePickup("Upgrade_BossGate_Final", new Vector2(114.5f, 1.2f));
            CreateCrate("Crate_Beach_A", new Vector2(16f, 1f), smallHealthPickup);
            CreateExplosiveBarrel("Barrel_Beach_A", new Vector2(22f, 1f));
            CreateCrate("Crate_CheckpointA_Recovery", new Vector2(35.5f, 1f), smallHealthPickup);
            ...
            CreateCrate("Crate_Village_Pressure", new Vector2(60f, 1f), null);
            CreateCrate("Crate_CheckpointB_Recovery", new Vector2(70f, 1f), smallHealthPickup);
            CreateExplosiveBarrel("Barrel_Trench_A", new Vector2(78f, 1f));
            CreateCrate("Crate_Trench_Health", new Vector2(92f, 1f), smallHealthPickup);
